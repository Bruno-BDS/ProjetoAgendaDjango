...
postgres=# create role usuario with login superuser createdb createrole password 'Bdspostgre9202';
CREATE ROLE
postgres=# create database projeto_agenda with owner usuario_agenda;
CREATE DATABASE
postgres=# grant all privileges on database base_de_dados_agenda to usuario;
GRANT
postgres=# \q
